...
def graphData():
    ...
    pdm = PreprocessDataManager(session['data_source'], session['reg_group_size'],
                                    1, session['col_name'], session['anomaly_std_threshold'], session['window_size'], session['speed_up'], 
